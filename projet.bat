@echo off
cd src
javac resources/Support/FFT/Complexe.java
javac resources/Support/FFT/ComplexeCartesien.java
javac resources/Support/FFT/FFTCplx.java
javac resources/Support/Son/Son.java
...
javac DetecteurDeSons.java
cd ..
java -cp src DetecteurDeSons
pause